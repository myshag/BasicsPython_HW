...
# Определить в нем атрибут title (название) и 
...
pen = Pen("канцелярская принадлежность")
pen.draw()

pencil = Pencil("канцелярская принадлежность")
pencil.draw()

handle = Handle("канцелярская принадлежность")
handle.draw()
